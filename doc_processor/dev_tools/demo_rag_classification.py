...
from database import find_similar_documents_by_tags, get_tag_usage_stats, analyze_tag_classification_patterns
...
def rag_enhanced_classification(document_text: str, document_name: str) -> Dict:
    ...
    try:
        ...
        if not extracted_tags:
            logging.warning(f"⚠️  No tags extracted - falling back to standard classification")
