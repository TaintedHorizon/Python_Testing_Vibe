...
**Current Development Status:** This project is currently testing the 'Finalize & Export' module. All prior modules (ingestion, OCR, AI classification, verification, review, grouping, and ordering) have been developed and tested successfully.
...
- **.env.sample**: Example environment file for onboarding
- **docs/USAGE.md**: Detailed usage guide, troubleshooting, and workflow instructions
...
### `docs/`
Documentation and usage guides. `docs/USAGE.md` provides detailed usage instructions, troubleshooting tips, and workflow guidance.
...
**Note:** For more detailed usage instructions, see `docs/USAGE.md`.
