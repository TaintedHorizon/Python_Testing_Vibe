...
**Current Development Phase:** This project is currently testing the 'Finalize & Export' module, with all prior modules (ingestion, OCR, AI classification, verification, review, grouping, and ordering) fully developed and tested.
...
### `docs/`
Documentation and usage guides. `USAGE.md` provides detailed usage instructions, workflow details, and troubleshooting guidance.
...
For detailed usage instructions and troubleshooting, see `docs/USAGE.md`.
