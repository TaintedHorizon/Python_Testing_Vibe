...
This project is currently testing the **'Finalize & Export'** module, with all prior modules developed and tested. The system provides a complete document processing workflow from intake through final export.
...
*   **Database**: SQLite
*   **OCR & Pre-processing**: EasyOCR and Tesseract OCR libraries, pdf2image for PDF conversion
...
### `docs/`
Documentation and usage guides. See `docs/USAGE.md` for detailed usage instructions, quick start guide, workflow details, and troubleshooting tips.
